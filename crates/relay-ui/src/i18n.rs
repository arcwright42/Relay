...
copy! {
    ...
    ProjectDetailsBody => ("A shared home for your conversations, sources, decisions, and results. Alex is the owner of this preview workspace.", "对话、资料、决策和成果都保存在项目中。Alex 是这个示例工作区的所有者。"),
    MoreOptions => ("More options", "更多选项"),
    ...
    SampleLibrary => ("Sample library · File import will be connected next.", "示例资料库 · 文件导入功能将在后续接入。"),
    ...
    ProductDesign => ("Product Design", "产品设计"),
    ProductDesignDetail => ("Turn ideas into reality.", "让想法成为现实。"),
    AgentInfra => ("Agent Infra", "智能体基础设施"),
    AgentInfraDetail => ("Build the foundations for better agents.", "为更好的智能体打好基础。"),
    Personal => ("Personal", "个人空间"),
    PersonalDetail => ("A little space for everything else.", "留一点空间，给生活中的其他想法。"),
    ContextClaude => ("Claude — Projects redesigned", "Claude — 项目全新设计"),
    ContextDesktop => ("Desktop interaction patterns", "桌面交互模式"),
    ContextAgent => ("Agent workspace research", "智能体工作区研究"),
    ContextNavigation => ("Project navigation references", "项目导航参考"),
    ContextDesign => ("Design systems collection", "设计系统资料"),
    ContextMemory => ("Context and memory research", "上下文与记忆研究"),
    ContextMultimodal => ("Multimodal interaction notes", "多模态交互笔记"),
    ContextAccessible => ("Accessible desktop interfaces", "桌面界面无障碍设计"),
    ContextBrief => ("Product brief", "产品简介"),
    ContextInterview => ("User interview notes", "用户访谈笔记"),
    ContextPrinciples => ("Design principles", "设计原则"),
    ContextArchitecture => ("Architecture overview", "架构概览"),
    ContextWorkspace => ("Workspace reference", "工作台参考"),
    ContextSelection => ("Selection toolbar reference", "划词工具栏参考"),
    Model => ("Model", "模型"),
    Mode => ("Mode", "权限模式"),
